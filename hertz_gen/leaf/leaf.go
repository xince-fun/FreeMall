...
type DecodeSnokflakeResponse struct {
	Timestamp  string `thrift:"timestamp,1" form:"timestamp" json:"timestamp" query:"timestamp"`
	SequenceId string `thrift:"sequenceId,2" form:"sequenceId" json:"sequenceId" query:"sequenceId"`
	WorkerId   string `thrift:"workerId,3" form:"workerId" json:"workerId" query:"workerId"`
}
...
type LeafServiceGenSegmentIdResult struct {
	Success *IdResponse `thrift:"success,0,optional"`
}
...
type LeafServiceDecodeSnowflakeIdArgs struct {
	Request *DecodeSnokflakeRequest `thrift:"request,1"`
}
...
type LeafServiceDecodeSnowflakeIdResult struct {
	Success *DecodeSnokflakeResponse `thrift:"success,0,optional"`
}
